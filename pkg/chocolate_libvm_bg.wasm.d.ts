...
export const vmdata_read_stack_at: (a: number, b: number) => number;
...
export const program_to_raw_beautified: (a: number) => [number, number];
export const program_to_raw: (a: number) => [number, number];
export const program_from_raw: (a: number, b: number) => number;
